...
class CategorySketch extends StatefulWidget {
  @override
  _CategorySketchState createState() => _CategorySketchState();
}

class _CategorySketchState extends State<CategorySketch> {
  ...
  Future<void> getDigitalArtProduct() async {
    ...
    try {
      final items = await productCollection
          .where("category", isEqualTo: "Sketch")
          .get();
