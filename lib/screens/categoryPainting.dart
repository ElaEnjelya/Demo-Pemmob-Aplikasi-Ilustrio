...
class CategoryPainting extends StatefulWidget {
  @override
  _CategoryPaintingState createState() => _CategoryPaintingState();
}

class _CategoryPaintingState extends State<CategoryPainting> {
