...
class CategoryDigitalArt extends StatefulWidget {
  @override
  _CategoryDigitalArtState createState() => _CategoryDigitalArtState();
}

class _CategoryDigitalArtState extends State<CategoryDigitalArt> {
  ...
  Future<void> getDigitalArtProduct() async {
    ...
    try {
      final items = await productCollection
          .where("category", isEqualTo: "Digital Art")
          .get();
